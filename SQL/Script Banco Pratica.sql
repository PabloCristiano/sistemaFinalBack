...
CREATE TABLE Compra (
    ...
    valor_produto DECIMAL(65, 6) NOT NULL,
    frete DECIMAL(65, 6) NOT NULL,
    seguro DECIMAL(65, 6) NOT NULL,
    outras_despesas DECIMAL(65, 6) NOT NULL,
    valor_compra DECIMAL(65, 6) NOT NULL,
...
CREATE TABLE compra_produto (
    ...
    qtd_produto INT NOT NULL,
    valor_unitario DECIMAL(65, 6) NOT NULL,
    valor_custo DECIMAL(65, 6) NOT NULL,
    total_produto DECIMAL(65, 6) NOT NULL,
    unidade VARCHAR(20) NOT NULL,
    desconto DECIMAL(65, 6),
    data_create TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    data_alt TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (
        compra_modelo,
...
create table contas_pagar(
    ...
    desconto DECIMAL(65, 6),
    juros DECIMAL(65, 6),
    valor_pago DECIMAL(65, 6),
    data_pagamento DATE,
    valor_parcela DECIMAL(65, 6),
    status VARCHAR(25),
    data_create TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    data_alt TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (
