...
class ControllerCliente extends Controller
{
    ...
    public function feedbacks()
    {
        $feedbacks = [
            ...
            'id_condicao.required' => 'O Código Condição Pagamento deve ser preenchido.',
            'id_condicao.integer' => 'O Código Condição Pagamento deve ser um número inteiro.',
